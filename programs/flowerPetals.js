...
function fillScene() {
    ...
    /*
    A few things to note in this above code
    what we are essentially doing here is called instancing, that means that we want to make separate objects with the same
    geometry. Since for every object we still have to create a mesh we are creating that in a loop but remeber we need the same geometry nevertheless.
    */

...
function fillScene() {
	...
	//in this exercise there is a gui control for changing the rotational angle of the light,
	//x=cosR and z=sinR, this is actually polar to cartesian coordinate transformation, essentially
...
function setupGui() {
	...
	//effectController as you can see is a js object and angle is an object inside it.
}

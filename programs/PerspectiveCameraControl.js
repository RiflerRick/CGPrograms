...
function setupGui()
{
    ...
    var gui=new dat.GUI();
    /*
    add is an overloaded function as far as I get it according to the documentation.
    add function:
    1st parameter: this parameter is used to refer to the js object that defines the properties 
        of the gui itself, in this case the field of view fov only, this contains the value 40 as default
    2nd parameter: this parameter refers to the property that we are currently referring to. In this case fov
    3rd parameter: this parameter refers to the min value that is possible in that control.
    4th parameter: refers to the maximum value.
    
    the add function returns a control element.
    */
...
function render() {
	...
	//the above line effects the field of view for the camera itself

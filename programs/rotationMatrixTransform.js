...
function fillScene() {
    ...
    //so we set here a vector (1,1,-1) to (-1,-1,1), vector (-1,1,1) to (1,-1,-1) and vector (-1,1,-1) to (1,-1,1)
    ...
    //this code is not very well optimized, aim for higher optimization.
